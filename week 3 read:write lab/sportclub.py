class SportClub:
    ...
    def __eq__(self, o: object) -> bool:
        ...
        if isinstance(o,SportClub):
            if self.getCity() == o.getCity() and self.getName() == o.getName() and self.getSport() == o.getSport():
                return True
    ...
    def __lt__(self, o: object) -> bool:
        ...
        # hint: object o may not be of type SportClub.
        if isinstance(o,SportClub):
            if self.getCount() < o.getCount():
                return True
            elif self.getCount() == o.getCount():
...
if __name__ == "__main__":
    print(SportClub("a","a","a",1) < SportClub("a","f","a",18))
